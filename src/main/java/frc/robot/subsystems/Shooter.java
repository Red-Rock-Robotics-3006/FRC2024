...
//     private SwerveIO swerve = TunerConstants.DriveTrain; // TODO FILLER
...
//                 this.setTarget(this.CENTER_ANGLE);
//                 break;
//             case SUB_LEFT: // Pressed up against left subwoofer
//                 this.setTarget(this.LEFT_ANGLE);
//                 break;
//             case SUB_RIGHT: // Pressed up against right subwoofer
//                 this.setTarget(this.RIGHT_ANGLE);
//                 break;
//             case PODIUM_BLUE: // Pressed up against blue podium
//                 this.setTarget(this.PODIUM_ANGLE, this.BLUE_PODIUM_HEADING);
//                 break;
//             case PODIUM_RED: // Pressed up against red podium
//                 this.setTarget(this.PODIUM_ANGLE, this.RED_PODIUM_HEADING);
//                 break;
//             case AMP: // Pressed up against amp
//                 this.setTarget(this.AMP_ANGLE);
//                 break;
//         }
